...
> 最后更新：2026-09-15
> 生财有术 Token 消耗排行榜的本地客户端 opentoken 的安装、验证、卸载与排查全流程。
...
| 机器 | 状态 | 版本 | 上报时刻 | 首次上报 |
|---|---|---|---|---|
| 本机 cw（192.168.2.8） | ✅ 已安装运行 | v0.3.30 | 每小时第 2/32 分 | 7 条用量记录 |
| 远程机 wj（192.168.2.9） | ❌ 已卸载 | — | — | — |

> 决策：仅保留本机安装，远程机已卸载（2026-09-15）。两台机器的用量数据会汇总到同一个生财账号下，但目前只统计本机。
