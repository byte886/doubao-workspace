...
| `AGENTS.md` | **细则手册**：记忆机制、归档细则、代理参数、技能规范 | 命中偏好指令"细则下钻"场景时读 | 用户与 AI 共建 |
| `PROFILE.md` | **白盒事实层**：身份/偏好、项目索引、外部资源指针，四分区 | 新对话冷启动主动读 | AI 任务收尾增量写 |
| `skills/` | **自建技能唯一根目录**（"怎么做"的可复用 SOP），共 13 个，见第四节 | 任务匹配命中时加载 | 用户与 AI 共建 |
